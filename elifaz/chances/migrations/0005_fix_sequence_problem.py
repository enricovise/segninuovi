...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        if orm.Schedulable.objects.count():
            highest_number = db.execute('select id from chances_schedulable order by id desc limit 1;')[0][0]
            db.execute('alter sequence chances_schedulable_id_seq restart with %s;' % (highest_number + 1))
