...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SchoolModule'
        db.create_table('board_schoolmodule', (
        ...
        db.send_create_signal('board', ['SchoolModule'])

        # Adding model 'SchoolReference'
        db.create_table('board_schoolreference', (
            ('post_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chances.Post'], unique=True, primary_key=True)),
            ('reference', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scuoladsc.Reference'])),
        ))
        db.send_create_signal('board', ['SchoolReference'])


    def backwards(self, orm):
        # Deleting model 'SchoolModule'
        db.delete_table('board_schoolmodule')

        # Deleting model 'SchoolReference'
        db.delete_table('board_schoolreference')
    ...
    models = {
        ...
        'board.schoolmodule': {
            'Meta': {'object_name': 'SchoolModule', '_ormbases': ['chances.Post']},
            'module': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scuoladsc.Module']"}),
            'post_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['chances.Post']", 'unique': 'True', 'primary_key': 'True'})
        },
        'board.schoolreference': {
            'Meta': {'object_name': 'SchoolReference', '_ormbases': ['chances.Post']},
            'post_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['chances.Post']", 'unique': 'True', 'primary_key': 'True'}),
            'reference': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scuoladsc.Reference']"})
        },
        'chances.post': {
