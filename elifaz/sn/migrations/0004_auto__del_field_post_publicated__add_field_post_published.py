...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Post.publicated'
        db.delete_column('sn_post', 'publicated')

        # Adding field 'Post.published'
        db.add_column('sn_post', 'published',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 2, 23, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Post.publicated'
        db.add_column('sn_post', 'publicated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 2, 23, 0, 0)),
                      keep_default=False)

        # Deleting field 'Post.published'
        db.delete_column('sn_post', 'published')
