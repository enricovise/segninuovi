...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sn_resource', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
        ))
        db.send_create_signal('sn', ['Resource'])

        # Adding model 'Person'
        db.create_table('sn_person', (
            ('resource_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sn.Resource'], unique=True, primary_key=True)),
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('biography', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sn.Organization'], null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'], null=True, blank=True)),
        ))
        db.send_create_signal('sn', ['Person'])

        # Adding model 'Material'
        db.create_table('sn_material', (
            ('resource_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sn.Resource'], unique=True, primary_key=True)),
            ('file', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File'])),
            ('date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal('sn', ['Material'])

        # Adding model 'Organization'
        db.create_table('sn_organization', (
            ('lemma_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['hypertext.Lemma'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('sn', ['Organization'])

        # Adding model 'Attribution'
        db.create_table('sn_attribution', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('sn', ['Attribution'])

        # Adding model 'Schedulable'
        db.create_table('sn_schedulable', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('venue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['places.Place'], null=True, blank=True)),
        ))
        db.send_create_signal('sn', ['Schedulable'])


    def backwards(self, orm):
        # Deleting model 'Resource'
        db.delete_table('sn_resource')

        # Deleting model 'Person'
        db.delete_table('sn_person')

        # Deleting model 'Material'
        db.delete_table('sn_material')

        # Deleting model 'Organization'
        db.delete_table('sn_organization')

        # Deleting model 'Attribution'
        db.delete_table('sn_attribution')

        # Deleting model 'Schedulable'
        db.delete_table('sn_schedulable')
