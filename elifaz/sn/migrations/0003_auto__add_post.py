...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sn_post', (
            ...
            ('publicated', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('sn', ['Post'])


    def backwards(self, orm):
        # Deleting model 'Post'
        db.delete_table('sn_post')
    ...
    models = {
        ...
        'sn.post': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'publicated': ('django.db.models.fields.DateTimeField', [], {}),
